...
unordered_map<string, vector<Rule>> getTable() {
    unordered_map<string, vector<Rule>> grammarRules = {
        {"S", {
            {"typeInt", "<BEGIN>"}
        }},
        {"RESERVED_TYPES", {
        ...
        {"BEGIN", {
            {"typeInt", "typeInt reserved_main symbol_parameter_init symbol_parameter_end symbol_op_init <CODE_BLOCK> symbol_op_end"},
            {"$", "sinc"}
        }},
        {"CODE_BLOCK", {
            {"typeInt", "<ATTRIBUTION> <CODE_BLOCK>"},
        ...
        {"EXPRESSION", {
            {"symbol_parameter_init", "<BOOL_EXPR> <EXPRESSION'> end_line"},
        ...
        {"EXPRESSION'", {
            {"op_arit_sum", "op_arit_sum <MULT_DIV> <EXPRESSION'>"},
            {"op_arit_sub", "op_arit_sub <MULT_DIV> <EXPRESSION'>"},
            {"end_line", "ε"}
        }},
        {"BOOL_EXPR", {
            {"symbol_parameter_init", "<MULT_DIV> <BOOL_EXPR'>"},
        ...
        {"BOOL_EXPR'", {
            {"op_log_e", "op_bool_e <MULT_DIV> <BOOL_EXPR'>"},
        ...
        {"MULT_DIV", {
            {"symbol_parameter_init", "<POW> <MULT_DIV>'"},
            {"id", "<POW> <MULT_DIV>'"},
            {"double", "<POW> <MULT_DIV>'"},
        ...
        {"MULT_DIV'", {
            {"op_arit_mult", "op_arit_mult <POW> <MULT_DIV'>"},
        ...
        {"POW'", {
            {"op_arit_pow", "op_arit_pow <VAR> <POW'>"},
            {"end_line", "ε"},
            {"op_arit_mult", "ε"},
            {"op_arit_div", "ε"},
            {"op_arit_sum", "ε"},
        ...
        {"VAR", {
            {"symbol_parameter_init", "symbol_parameter_init <EXPRESSION> symbol_parameter_end"},
            {"id", "id"},
            {"double", "double"},
            {"integer", "integer"},
            {"bool_false", "<VAR> <POW>"},
        ...
        {"ATTRIBUTION_VALUE", {
            {"bool_false", "bool_false end_line"},
        ...
        {"ATTRIBUTION", {
            {"typeInt", "<RESERVED_TYPES> <ATTRIBUTION>'"},
        ...
        {"ATTRIBUTION''", {
            {"op_rel_equal", "op_rel_equal <ATTRIBUTION_VALUE>"},
            {"symbol_op_end", "sinc"},
            {"typeInt", "sinc"},
            {"typeDouble", "sinc"},
            {"typeBoolean", "sinc"},
        ...
        {"ATTRIBUTION_BOOL", {
            {"typeBoolean", "typeBoolean id <ATTRIBUTION_BOOL'>"},
            {"symbol_op_end", "sinc"},
            {"typeInt", "sinc"},
            {"typeDouble", "sinc"},
            {"typeBoolean", "sinc"},
        ...
        {"ATTRIBUTION_BOOL'", {
            {"op_rel_equal", "op_rel_equal <ATTRIBUTION_BOOL''>"},
            {"end_line", "endline"},
            {"symbol_op_end", "sinc"},
            {"typeInt", "sinc"},
            {"typeDouble", "sinc"},
        ...
        {"ATTRIBUTION_BOOL'''", {
            {"op_log_e", "<LOG_SYMBOLS> <ID_OR_VALUE> <ATTRIBUTION_BOOL'''>"},
            {"op_log_or", "<LOG_SYMBOLS> <ID_OR_VALUE> <ATTRIBUTION_BOOL'''>"},
            {"end_line", "ε"}
        }},
        {"ATTRIBUTION_STR", {
            {"typeStr", "typeStr id <ATTRIBUTION_STR'>"},
            {"symbol_op_end", "sinc"},
            {"typeInt", "sinc"},
            {"typeDouble", "sinc"},
            {"typeBoolean", "sinc"},
        ...
        {"ATTRIBUTION_STR'", {
            {"op_rel_equal", "op_rel_equal text_between_quotes end_line"},
            {"symbol_op_end", "sinc"},
            {"typeInt", "sinc"},
            {"typeDouble", "sinc"},
            {"typeBoolean", "sinc"},
        ...
        {"PRINT", {
            {"reserved_prt", "reserved_prt symbol_parameter_init <ID_OR_STRING> symbol_parameter_end end_line"},
            {"symbol_op_end", "sinc"},
            {"typeInt", "sinc"},
            {"typeDouble", "sinc"},
            {"typeBoolean", "sinc"},
        ...
        {"ID_OR_STRING'", {
            {"op_arit_sum", "op_arit_sum <ID_OR_STRING''> <ID_OR_STRING'>"},
        ...
        {"SCAN", {
            {"reserved_scn", "reserved_scn symbol_parameter_init id symbol_parameter_end end_line"},
            {"symbol_op_end", "sinc"},
            {"typeInt", "sinc"},
            {"typeDouble", "sinc"},
            {"typeBoolean", "sinc"},
        ...
        {"CIRCUIT_LOG'", {
            {"op_arit_sum", "<LOOPS_SYMBOLS> <CIRCUIT_LOG>"},
        ...
        {"PIT", {
            {"pitEntry", "pitEntry symbol_parameter_init <PIT_LOG> symbol_parameter_end symbol_op_init <CODE_BLOCK> symbol_op_end <PIT_EXIT>"},
            {"symbol_op_end", "sinc"}
        }},
        {"PIT_LOG", {
            {"id", "id <PIT_LOG'>"},
        ...
        {"PIT_LOG'", {
            {"op_arit_sum", "<LOOPS_SYMBOLS> <PIT_LOG>"},
        ...
        {"PIT_EXIT", {
            {"pitExit", "pitExit symbol_op_init <CODE_BLOCK> symbol_op_end"},
            {"symbol_op_end", "ε"}
        }}
    };
